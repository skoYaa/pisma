...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body style="background: -moz-linear-gradient(top, rgba(32,124,229,1) 0%, rgba(123,183,239,0.1) 18%, rgba(123,183,239,0) 20%);">
        ...
        <div id="wrapper">
            ...
            <header>
                ...
                <div class="row" style=" background-repeat: no-repeat; background-color:  rgba(123,183,239,0.1)">
                    <div class="col-md-3">
        ...
        <footer>
            <div style="background-color:  rgba(32,124,229,1); position: relative; width: 100%;">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="widget">
