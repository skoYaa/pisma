...
<script src="../../web/js/jssor.js" type="text/javascript"></script>
<script src="../../web/js/jssor.slider.js" type="text/javascript"></script>
<script>
...
<div class="container" style="padding-top: 40px;" >
    ...
    if(!isset($_GET['q'])){ ?>
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px;
            ...
            <div><img u="image" src="../../web/img/1.jpg" alt="1"/></div>
            <div><img u="image" src="../../web/img/2.jpg" alt="2"/></div>
            <div><img u="image" src="../../web/img/3.jpg" alt="3"/></div>
        </div>
